...
class fisica(object):
    ...
    def write(self, txBuffer):
        ...
        This command takes a buffer and format it before transmit. This is necessary because the pyserial and 
        arduino uses Software flow control between both sides of communication.
        """
    ...
    def read(self, nBytes):
        ...
        Nem toda a leitura retorna múltiplo de 2, devemos verificar isso para evitar que a funcao
        ...
        try :
            """ As vezes acontece erros na decodificacao  fora do ambiente linux, isso tenta corrigir em parte esses erros. Melhorar futuramente."""
